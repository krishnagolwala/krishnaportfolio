...
interactiveElements.forEach(el => {
    el.addEventListener('mouseenter', () => {
        ...
        if (el.tagName !== 'DIV') { // Don't scale large containers too much, just text
...
// Soft hover animations for cards
...
console.log('Portfolio reverted to clean text-magnifier state!');
